...
# We can define our own functions using def keyword
...
# Now in this topic if we want to make multiple fuctions we can use

def main():
    print("Welcome")
    welcome('Bhumidhar')    # It can be seen as a the main code when we want to define mulltiple functions
main()
...
def mulltipl(num):
    newNum = square(num)
    print(f"The square of the number is : {newNum}")
mulltipl(45)